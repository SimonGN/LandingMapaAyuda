		...
		<FooterStyle display={props.display}>
			<div className='green'>
				...
				<div className='textGreen'>
					...
					<ParagraphBodyRegular color={theme.colors.dark100} align='center'>
						{t('subTitle')}
					...
					<div className='navSeo'>
						<div className='idiomsMovil'>
							<ParagraphBodySmall
								...
								showCursor
								onClick={() => changeLanguage('es', setLangauge)}
							>
								Español
							</ParagraphBodySmall>
							...
							<ParagraphBodySmall
								...
								showCursor
								onClick={() => changeLanguage('en', setLangauge)}
							>
								English
							</ParagraphBodySmall>
						</div>
					...
					<div className='nameText'>
						...
						<div className='legal'>
							...
							<div className='sectionLegal'>
								<Link href='/about'>
									<ParagraphBodySmall size='12px'>{t('link1')}</ParagraphBodySmall>
								</Link>
								<Link href='/about'>
									<ParagraphBodySmall size='12px'>{t('link2')}</ParagraphBodySmall>
								</Link>
							</div>
						</div>
					</div>
